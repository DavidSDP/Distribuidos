...
public class BeanstalkdClientImpl implements BeanstalkdClient
{
    ...
    public BeanstalkdClientImpl()
    {
        this(DEFAULT_HOST, DEFAULT_PORT);
    }

    public BeanstalkdClientImpl(String host, int port)
    {
        this.host = host;
        this.port = port;
    ...
    public BeanstalkdClientImpl(boolean useBlockIO)
    {
        this(DEFAULT_HOST, DEFAULT_PORT);
        getProtocolHandler().setUseBlockIO(useBlockIO);
    }

    public BeanstalkdClientImpl(String host, int port, boolean useBlockIO)
    {
        this(host, port);
        getProtocolHandler().setUseBlockIO(useBlockIO);
    }
    ...
    // ****************************************************************	
    @Override
    public BeanstalkdJob reserve(Integer timeoutSeconds)
    {
        BeanstalkdJob job = null;
        ...
        if(response != null && response.isMatchOk())
        {
            ...
            job = new BeanstalkdJobImpl(jobId);
    ...
    // ****************************************************************
    @Override
    public BeanstalkdJob peek(long jobId)
    {
        BeanstalkdJob job = null;
        Request request = new Request(
                "peek " + jobId,
    ...
    @Override
    public BeanstalkdJob peekDelayed()
    {
        BeanstalkdJob job = null;
        Request request = new Request(
                "peek-delayed",
    ...
    @Override
    public BeanstalkdJob peekReady()
    {
        BeanstalkdJob job = null;
        Request request = new Request(
                "peek-ready",
